    ...
    <div class="analysis-content-body" >
      <div class="upload-tool">
        <span>
          ...
          <el-button type="success" size="medium"  @click="btnClick">上传并预览excel</el-button>
        </span>
        <span>
          <el-upload
            class="upload-demo"
        ...
        <el-button type="primary" @click="openColumnDrawer" size="medium" class="button">查看显示列</el-button>
