    ...
    <div>
      ...
      <el-card>
        ...
        >
          ...
          <el-table-column prop="action1" label="操作" fixed="right">
            <template #default="scope">
              <el-button type="link" @click="showDialog1(scope.row)"
                >修改</el-button
              >
            </template>
          </el-table-column>
        ...
        <el-dialog title="修改" v-model="dialogVisible" v-bind="$attrs">
          <el-form :model="Statement" label-width="80px">
            <el-form-item label="类型">
              <el-input v-model="Statement.type" disabled></el-input>
            </el-form-item>
            <el-form-item label="具体内容">
              <el-input v-model="Statement.content"></el-input>
            </el-form-item>
          </el-form>
          <div slot="footer" class="dialog-footer centered-buttons">
            <el-button type="primary" @click="modifyStatement">提 交</el-button>
        ...
        <el-dialog title="删除记录" v-model="applyVisible" v-bind="$attrs">
          <el-form :model="Statement" label-width="80px">
            ...
            <el-form-item label="具体内容">
              <el-input v-model="Statement.content" disabled></el-input>
            </el-form-item>
          </el-form>
          <h1 class="delete-reminder">确定删除此条记录吗？</h1>
          <div slot="footer" class="dialog-footer centered-buttons">
            <el-button type="primary" @click="deleteStatement">确 定</el-button>
        ...
        <div class="centered-container">
          <el-form-item>
            <el-button type="success" @click="add" class="add"
              >新增记录</el-button
            >
          </el-form-item>
        </div>
...
<script>
import { viewSta } from "../api/login.js";
import { deleteSta } from "../api/login.js";
import { modifySta } from "../api/login.js";
...
export default {
  ...
  methods: {
    ...
    showDialog1(row) {
      this.Statement = Object.assign({}, row); //将row的值赋给data()中
    ...
    modifyStatement() {
      ...
      modifySta(this.Statement.id, this.Statement.type, this.Statement.content)
        .then((response) => {
          console.log(response.data);
          this.applyVisible = false; //关闭弹窗
          this.fetchStatementList(); //刷新列表
